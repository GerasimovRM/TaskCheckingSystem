...
export const LessonPreviewTaskInfoForStudent: (props: ILessonPreview) => JSX.Element = (props: ILessonPreview) => {
    const [state, setState] = useState<ILessonStat>()
    const [isLoading, setIsLoading] = useState<boolean>(true)
    useEffect(() => {
            StatService.getLessonStat(props.groupId, props.courseId, props.lessonId).then(
                lesson_stat => {
